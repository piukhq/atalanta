...
fn create_transactions() -> Result<Vec<Transaction>> {
    let toffee_transaction = vec![
        Transaction{
            ...
            transaction_date: DateTime::parse_from_str("2014-11-28 21:00:09 +00:00", "%Y-%m-%d %H:%M:%S %:z")?,
        ...
        Transaction{
            ...
            transaction_date: DateTime::parse_from_str("2014-11-20 21:00:09 +00:00", "%Y-%m-%d %H:%M:%S %:z")?,
            merchant_name: "Bink toffee".to_string(),
