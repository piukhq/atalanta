    ...
    fn format(transactions: Vec<Transaction>) -> Result<String> {
        ...
        for transaction in transactions {
            let tx = json!({
                ...
                "metadata": r#"{"item": "some metadata"}"#,
                "items_ordered": "{\"products\":[{\"id\":\"2\",\"productUuid\":\"534084a0-a6a3-11ec-b020-211a45f43f11\",\"variantUuid\":\"5341e430-a6a3-11ec-a1a4-0f05978902ad\",\"description\":\"\",\"name\":\"Test product 1\",\"sku\":\"sku1\",\"unitPrice\":30,\"costPrice\":10,\"quantity\":\"2\",\"vatPercentage\":0.0,\"taxRates\":[{\"percentage\":0}],\"taxExempt\":false,\"autoGenerated\":false,\"type\":\"PRODUCT\"}"
            });
